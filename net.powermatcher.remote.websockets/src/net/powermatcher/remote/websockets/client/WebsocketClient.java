...
public class WebsocketClient
    ...
    private void disconnectRemote() {
        ...
        Session ses = remoteSession;
        if (ses != null && ses.isOpen()) {
            ses.close(new CloseStatus(0, "Normal disconnect"));
        }
    }
     ...
     * @param newBid
     *            the bid to publish
     * @return bidupdate containing bidnumber and published bid when published successfully, null otherwise.
     */
    private BidUpdate publishBid(AggregatedBid newBid) {
        ...
        if (ses != null && ses.isOpen()) {
            ...
            LOGGER.info("Can not send new bid, not connected.");
            return null;
        }
    }
    ...
    private void unregisterMatcherEndpoint() {
        ServiceRegistration<MatcherEndpoint> reg = matcherEndpointServiceRegistration;
        if (reg != null) {
            reg.unregister();
