 ...
 * @version 0.9.0
 * 
 * Message-Driven Bean implementation class for: EventDataProcessorBean
 *
 */
@MessageDriven(
		...
		mappedName = "Telemetry")
public class EventDataProcessorBean implements MessageListener {

	/**
	 * Define the logger (Logger) field.
	 */
	protected final static Logger logger = Logger.getLogger(EventDataProcessorBean.class.getName());
	private static final Charset UTF8 = Charset.forName("UTF8");
	
    /**
     * Default constructor. 
     */
    public EventDataProcessorBean() {
