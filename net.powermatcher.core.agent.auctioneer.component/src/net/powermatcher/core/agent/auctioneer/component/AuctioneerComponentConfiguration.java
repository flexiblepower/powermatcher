...
import net.powermatcher.core.agent.auctioneer.config.AuctioneerConfiguration;
 ...
 * @version 0.9.0
 */
@OCD(name = "PowerMatcher Auctioneer")
public interface AuctioneerComponentConfiguration extends AuctioneerConfiguration {
	...
	@Override
	@Meta.AD(required = false, description = PRICING_ADAPTER_FACTORY_DESCRIPTION)
