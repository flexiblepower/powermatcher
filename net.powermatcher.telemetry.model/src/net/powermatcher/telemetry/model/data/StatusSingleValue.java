 ...
 * @version 0.9.0
 */
public class StatusSingleValue extends Data {
	/**
	 ...
	 * @see #StatusSingleValue(String,Date)
	 */
	public StatusSingleValue(final Map<String, Object> dataMap) {
		super(dataMap);
	}
	 ...
	 * @see #StatusSingleValue(Map)
	 */
	public StatusSingleValue(final String value, final Date ts) {
