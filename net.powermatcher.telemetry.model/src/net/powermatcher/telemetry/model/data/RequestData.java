...
public class RequestData extends RequestResponseData {
	 ...
	 * @see 
	 *      #RequestData(String, String, Set, Date)
	 */
	public RequestData(Map<String, Object> dataMap) {
		super(dataMap);
	}
	 ...
	 * @see #RequestData(Map)
	 */
	public RequestData(String requestType, String requestId, Set<RequestResponseProperty> propertySet, Date ts) {
