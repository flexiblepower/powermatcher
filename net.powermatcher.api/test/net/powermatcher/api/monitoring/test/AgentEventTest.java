...
public class AgentEventTest {
	...
	public void testIncomingBidEvent() {
		IncomingBidEvent ibe = new IncomingBidEvent(clusterId, agentId,
				sessionId, timestamp, fromAgent, bid, agentQualifier);
	...
	public void testOutgoingBidEvent() {
		OutgoingBidEvent obe = new OutgoingBidEvent(clusterId, agentId,
				sessionId, timestamp, bid, agentQualifier);
	...
	public void testIncomingPriceUpdateEvent() {
		IncomingPriceUpdateEvent ice = new IncomingPriceUpdateEvent(clusterId,
				agentId, sessionId, timestamp, priceUpdate, agentQualifier);
	...
	public void testOutgoingPriceUpdateEvent() {
		OutgoingPriceUpdateEvent oce = new OutgoingPriceUpdateEvent(clusterId,
				agentId, sessionId, timestamp, priceUpdate, matcherQualifier);
