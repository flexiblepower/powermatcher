...
public class PointBidTest {
	...
	public void setUp() throws Exception {
		...
		this.bidNumber = 1;
		pricePoints1 = new PricePoint[] {
				pricePoint(marketBasisFiveSteps, -1, 10.0),
				pricePoint(marketBasisFiveSteps, 7, 2.0) };
		pricePoints2 = new PricePoint[] {
				pricePoint(marketBasisTenSteps, 1, 20.0),
	 ...
	 */
	private PricePoint pricePoint(MarketBasis marketBasis, int price,
			double demand) {
	...
	public void testConstructor() {
		PointBid bid = new PointBid(marketBasisFiveSteps, bidNumber,
				pricePoints1);
	...
	public void testBuilderAddPricePoint() {
		PricePoint pricePoint = new PricePoint(new Price(marketBasisFiveSteps,
				3), 10);
	...
	public void testToArrayBid() {
		...
		expected = new double[] { 20.0, 20.0, 20.0, 20.714285714285715,
				21.428571428571427, 22.142857142857142, 22.857142857142858,
				23.571428571428573, 24.285714285714285, 25.0 };
		assertThat(arrayBid.getDemand(), is(equalTo(expected)));
	}
	...
	public void testAggregateBid() {
		PointBid other = new PointBid(marketBasisFiveSteps, bidNumber,
				pricePoints1);
		ArrayBid aggregatedBid = bid1.aggregate(other);
		assertThat(aggregatedBid.getBidNumber(), is(equalTo(0)));
		assertThat(aggregatedBid.getMarketBasis(),
	...
	public void testIterator() {
		PricePoint pp1 = new PricePoint(new Price(marketBasisFiveSteps, 3),
				10.0);
		PricePoint pp2 = new PricePoint(new Price(marketBasisFiveSteps, 5),
				20.0);
		PricePoint pp3 = new PricePoint(new Price(marketBasisFiveSteps, 7),
				30.0);
	...
	public void testEquals() {
		...
		Bid testBid = new PointBid(marketBasisFiveSteps, bidNumber,
				pricePoints1);
		...
		MarketBasis equalsBasis = new MarketBasis(COMMODITY_ELECTRICITY,
				CURRENCY_EUR, 5, -1.0d, 7.0d);
		PricePoint[] equalsArray = new PricePoint[] {
				pricePoint(marketBasisFiveSteps, -1, 10.0),
				pricePoint(marketBasisFiveSteps, 7, 2.0) };
