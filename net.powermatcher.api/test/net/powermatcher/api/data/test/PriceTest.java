...
public class PriceTest {
	...
	public void setUp() throws InvalidParameterException {
		this.marketBasis = new MarketBasis(COMMODITY_ELECTRICITY, CURRENCY_EUR,
				10, -1.0d, 8.0d);
	...
	public void testGetMarketBasis() {
		...
		MarketBasis marketBasis2 = new MarketBasis(COMMODITY_ELECTRICITY,
				CURRENCY_EUR, 10, -1.0d, 8.0d);
		assertEquals(marketBasis2, this.price.getMarketBasis());
		marketBasis2 = new MarketBasis(COMMODITY_ELECTRICITY, CURRENCY_EUR, 20,
				-1.0d, 8.0d);
