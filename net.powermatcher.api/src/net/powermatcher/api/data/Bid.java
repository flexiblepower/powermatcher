...
/**
 * This immutable abstract data object defines the basis for a Bid in the Powermatcher cluster. The bid curve
 * can be represented in several ways, so subclasses will have their own implementation.
 * 
 * @author FAN
 * @version 2.0
 */
public abstract class Bid {
    ...
    public double getDemandAt(PriceStep priceStep) {
        // FIXME The overridden methods are fine, but calling this method or getDemandAt(Price) would cause a stack overflow if called. .
        // They are placed here so that you can call Bid.getDemandAt. You won't have to cast, but this isn't correct either.
        // Possible solutions: return null (could cause NullpointerExceptions), throw UnsupportedOperationException or
        // cast the Bids.
