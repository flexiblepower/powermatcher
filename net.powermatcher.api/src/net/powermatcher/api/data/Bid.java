...
/**
 * <p>
 * Bid is an immutable data class specifying a bid curve in either price points or by an demand array representation.
 * </p>
 * 
 * @author FAN
 * @version 1.0
...
public class Bid {
    ...
    /**
     * Constructs an instance of this class from the specified other parameter, but assign a new bid number.
     * 
     * @param other
     *            The other (<code>Bid</code>) parameter.
     * @see #Bid(MarketBasis)
    ...
    /**
     * Constructs an instance of this class from the specified market basis parameter. An zero bid is created.
     * 
     * @param marketBasis
    ...
    /**
     * Constructs an instance of this class from the specified market basis and price point parameters. The price point
     * will be cloned.
     * 
     * @param marketBasis
     *            The market basis (<code>MarketBasis</code>) parameter.
    ...
    /**
     * Constructs an instance of this class from the specified market basis, price point1 and price point2 parameters.
     * The price points will be cloned.
     * 
     * @param marketBasis
     *            The market basis (<code>MarketBasis</code>) parameter.
     * @param pricePoint1
    ...
    /**
     * Constructs an instance of this class from the specified market basis and price points parameters. The demand
     * array will not be cloned, so should not be updated beyond this call.
     * 
     * @param marketBasis
     *            The market basis (<code>MarketBasis</code>) parameter.
     * @param bidNumber
    ...
    /**
     * Constructs an instance of this class from the specified market basis and price points parameters. The price
     * points array will be cloned.
     * 
     * @param marketBasis
     *            The market basis (<code>MarketBasis</code>) parameter.
     * @param pricePoints
    ...
    /**
     * Constructs an instance of this class from the specified market basis, bid number and demand parameters. The
     * demand array will not be cloned, so should not be updated beyond this call.
     * 
     * @param marketBasis
     *            The market basis (<code>MarketBasis</code>) parameter.
     * @param bidNumber
    ...
    /**
     * Calculate intersection with the specified target demand and return the Price result.
     * 
     * @param targetDemand
    ...
    public Price calculateIntersection(final double targetDemand) {
         ...
         */
        while (rightBound < unclonedDemand.length && unclonedDemand[rightBound] >= targetDemand) {
            rightBound += 1;
        }
        ...
        if (leftBound > 0 && rightBound < unclonedDemand.length) {
            ...
            if (leftBound == 0 && rightBound == unclonedDemand.length) {
                ...
                /* Curve is a single step at leftBound */
                priceStep = unclonedDemand[leftBound] <= targetDemand ? leftBound : leftBound + 1;
            }
        }
        ...
        if (this.marketBasis.equals(newMarketBasis)) {
            ...
            if (this.pricePoints == null) {
                ...
                for (int i = 0; i < newPricePoints.length; i++) {
                    ...
                    double price = this.marketBasis.toPrice(this.marketBasis.toPriceStep(oldPricePoint
                            .getNormalizedPrice()));
                    newPricePoints[i] = new PricePoint(newMarketBasis.toNormalizedPrice(price),
    ...
    /**
     * Get demand with the specified price parameter and return the double result.
     * 
     * @param price
     ...
     * 
     * @return The cloned price points (<code>PricePoint[]</code>) value, or null if the price points have not been
     *         calculated or set.
    ...
    /**
     * Gets the cloned calculated price points (PricePoint[]) value. The price points will be calculated from the demand
     * array, if necessary.
     * 
     * @return The cloned price points (<code>PricePoint[]</code>) value, or null if no price points or demand array has
     *         been set.
     * @see #getPricePoints()
     */
    ...
    /**
     * Get scale factor with the specified max value parameter and return the double result.
     * 
     * @param maxValue
        ...
        if (points != null && points.length < this.marketBasis.getPriceSteps() / 2) {
            ...
            if (unclonedDemand != null) {
                ...
                for (int i = 0; i < unclonedDemand.length; i++) {
                    ...
                    b.append(MarketBasis.DEMAND_FORMAT.format(unclonedDemand[i]));
                }
                b.append("}, ");
            }
        }
