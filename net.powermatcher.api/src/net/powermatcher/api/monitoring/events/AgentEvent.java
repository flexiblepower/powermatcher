...
/**
 * This immutable abstract data object defines the basis for a event. AgentEvent
 * is an event worthy of notifying other object of.
 * 
 * Classes implementing the {@link ObservableAgent} interface and can send an
 * {@link AgentEvent} to every {@link AgentObserver} that observes this class.
 * 
 * @author FAN
 * @version 2.0
 */
...
public abstract class AgentEvent {
	...
	/**
	 * The id of cluster the {@link AgentEndpoint} subclass sending the
	 * UpdateEvent is running in.
	 */
	...
	public String toString() {
		return "clusterId = " + this.clusterId + ", agentId = " + this.agentId
