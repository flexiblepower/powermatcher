...
/**
 * An {@link PeakShavingEvent} is sent when an PeakShavingConcentrator
 * transforms an aggregated {@link Bid} by peakshaving the demandArray.
 * 
 * @author FAN
 * @version 2.0
 */
public class PeakShavingEvent extends AgentEvent {
	 ...
	 *            The {@link Price} after the peakshaving.
	 */
	public PeakShavingEvent(String agentId, String clusterId, Date timestamp,
			double floor, double ceiling, double[] oldDemand,
			double[] newDemand, Price newPrice, Price oldPrice) {
	...
	public String toString() {
		...
		return super.toString() + ", floor = " + floor + ", ceiling = "
				+ ceiling + sb.toString();
	}
}
