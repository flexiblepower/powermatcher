...
/**
 * An {@link OutgoingBidEvent} is sent when an {@link AgentEndpoint} sends a new
 * {@link Bid}.
 * 
 * @author FAN
 * @version 2.0
...
public class OutgoingBidEvent extends BidEvent {
	 ...
	 *            subclass.
	 */
	public OutgoingBidEvent(String clusterId, String agentId, String sessionId,
	...
	public String toString() {
		return OutgoingBidEvent.class.getSimpleName() + " " + super.toString()
				+ ", bid = " + getBid().toString();
	}
}
