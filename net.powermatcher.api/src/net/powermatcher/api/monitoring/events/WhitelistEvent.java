...
/**
 * A {@link WhitelistEvent} is sent when an {@link MatcherEndpoint} rejects a
 * connection, because the {@link AgentEndpoint} was not on its whitelist.
 * 
 * @author FAN
 * @version 2.0
 */
public class WhitelistEvent extends AgentEvent {
	 ...
	 */
	public WhitelistEvent(String agentId, String blockedAgent,
			String clusterId, Date timestamp) {
