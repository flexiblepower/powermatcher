...
/**
 * {@link AgentEndpointProxy} defines the interface and contains all basic methods needed to enable remote communication
 * between an {@link AgentEndpoint} and a remote {@link MatcherEndpoint} through a {@link MatcherEndpointProxy}. The
 * means of communication is up to the implementing class.
 * 
 * @author FAN
 * @version 2.0
 */
