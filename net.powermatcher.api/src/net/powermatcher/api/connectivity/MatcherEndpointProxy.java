...
public interface MatcherEndpointProxy extends MatcherEndpoint {
    ...
    /**
     * Sends the {@link PriceUpdate} it receives from the remote {@link AgentEndpoint} through the
     * {@link AgentEndpoint} to the local {@link AgentEndpoint} through the local {@link Session}.
     * 
     * @param priceUpdate
