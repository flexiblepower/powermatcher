...
/**
 * A {@link AgentRole} defines the interface for classes that can receive a {@link Price} and send a {@link Bid}, based
 * on that {@link Price}. An {@link AgentRole} can be linked with zero of one {@link MatcherRole} instances. These are
