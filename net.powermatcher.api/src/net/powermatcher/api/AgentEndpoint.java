...
public interface AgentEndpoint extends Agent {
    ...
    /**
     * Disconnects this {@link AgentEndpoint} instance from a {@link MatcherEndpoint}.
     * 
     * @param session
     *            the {@link Session} that links this {@link AgentEndpoint} with its {@link MatcherEndpoint}.
     */
    void matcherEndpointDisconnected(Session session);

    /**
     * Called by {@link MatcherEndpoint} to update the {@link Price} used by this {@link AgentEndpoint} instance.
     * 
     * @param priceUpdate
