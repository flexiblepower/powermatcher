 ...
 * @version 0.9.0
 */
public class InternalMessageFactory implements MessageFactory {
	/**
	...
	public static MessageFactory getInstance() {
		return new InternalMessageFactory();
	}
	...
	private InternalMessageFactory() {
		this.marketBasisCache = new MarketBasisCache(new InternalMarketBasisMapper());
	}
	...
	public BidInfo toBidInfo(final byte[] data) throws InvalidObjectException {
		BidMessage bidMessage = new InternalBidMessage(this.marketBasisCache, data);
	...
	public BidMessage toBidMessage(final BidInfo bidInfo) {
		...
		return new InternalBidMessage(externalBidInfo);
	}
	...
	public PriceInfo toPriceInfo(final byte[] data) throws InvalidObjectException {
		PriceInfoMessage priceInfoMessage = new InternalPriceInfoMessage(this.marketBasisCache, data);
	...
	public PriceInfoMessage toPriceInfoMessage(final PriceInfo priceInfo) {
		...
		InternalPriceInfoMessage priceInfoMessage = new InternalPriceInfoMessage(externalPriceInfo);
