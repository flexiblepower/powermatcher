...
import net.powermatcher.agent.peakshavingconcentrator.config.PeakShavingConcentratorConfiguration;
 ...
 * @version 0.9.0
 */
@OCD(name = "PowerMatcher Peak Shaving Concentrator")
public interface PeakShavingConcentratorComponentConfiguration extends PeakShavingConcentratorConfiguration {
	...
	@Override
	@Meta.AD(required = false, description = PEAK_SHAVING_ADAPTER_FACTORY_DESCRIPTION)
