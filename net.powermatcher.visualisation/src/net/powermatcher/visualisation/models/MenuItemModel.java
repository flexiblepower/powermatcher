...
/**
 * A data object representing a Menu item for the visualizer. The menu contains
 * {@link MenuItemModel}'s, with a title and one or more
 * {@link SubMenuItemModel}. For example: the Device Agent menu item can have
 * Freezer and PvPanel as {@link SubMenuItemModel}'s
 * 
 * @author FAN
 * @version 2.0
 */
