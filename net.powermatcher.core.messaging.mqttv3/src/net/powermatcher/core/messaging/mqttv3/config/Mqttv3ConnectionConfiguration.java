package net.powermatcher.core.messaging.mqttv3.config;
 ...
 * @version 0.9.0
 */
public interface Mqttv3ConnectionConfiguration extends AdapterConfiguration {
	/**
	 ...
	 */
	public static final String BROKER_DEFAULT_URI = "tcp://localhost:1883";
	/**
	 ...
	 */
	public static final String NOTIFICATION_COMPONENT_NAME_DEFAULT = "net.powermatcher.core.messaging.mqttv3.Mqttv3Connection";
	/**
