...
public class ResilienceTest {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(ResilienceTest.class);
	...
	protected Bid nextBidToMatcher(int id) throws IOException,
			DataFormatException {
		MockAgent newAgent;
	...
	protected void checkAggregatedBid(ArrayBid aggregatedBid) {
		assertArrayEquals(this.resultsReader.getAggregatedBid().getDemand(),
				aggregatedBid.getDemand(), 0);
	}
}
