...
public class ConcentratorResilienceTestICF extends ConcentratorResilienceTest {
	 ...
	 */
	@Test
	public void sendAggregatedBidICF1Test1() throws IOException,
			DataFormatException {
	 ...
	 */
	@Test
	public void sendAggregatedBidICF1Test2() throws IOException,
			DataFormatException {
	 ...
	 * the bids will be incorrect (ascending bid). The concentrator should
	 * reject the incorrect bid.
	 * 
	 ...
	 */
	@Test
	public void sendAggregatedBidRejectAscendingICF2() throws IOException,
			DataFormatException {
		performAggregatedBidTest("ICF/ICF2", null);
	}

	/**
	 * A set of agents send a bid to the matcher via the concentrator. The the
	 * matcher will send a price to the concentrator. Check if the concentrator
	 * receives and forwards the correct price.
	 * 
	 * @throws IOException
	 * @throws DataFormatException
	 */
	@Test
	public void receiveAndForwardPriceICF3() throws IOException,
			DataFormatException {
		...
		// Send price
		PriceUpdate equilibrium = new PriceUpdate(new Price(this.marketBasis,
				this.resultsReader.getEquilibriumPrice()), 2);
		...
		Assert.assertEquals(this.concentrator.getLastPrice(),
