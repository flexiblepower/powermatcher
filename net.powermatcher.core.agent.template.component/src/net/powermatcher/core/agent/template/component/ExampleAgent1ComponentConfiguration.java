 ...
 * configuration properties for <code>ExampleAgent1</code>. The interface defines a
 ...
 * 
 * @see ExampleAgent1
 * @see ExampleAgent1Component
 * 
 * @author IBM
 * @version 0.9.0
 */
@OCD(name = "PowerMatcher Example Agent 1")
public interface ExampleAgent1ComponentConfiguration extends ExampleAgent1Configuration {
