 ...
 * 
 * @see ExampleAgent2
 * @see ExampleAgent2ComponentConfiguration
 * 
 * @author IBM
 * @version 0.9.0
 */
@Component(name = ExampleAgent2Component.COMPONENT_NAME, designateFactory = ExampleAgent2ComponentConfiguration.class)
public class ExampleAgent2Component extends ExampleAgent2 {
	/**
	 ...
	 */
	public final static String COMPONENT_NAME = "net.powermatcher.core.agent.example.ExampleAgent2";
	/**
