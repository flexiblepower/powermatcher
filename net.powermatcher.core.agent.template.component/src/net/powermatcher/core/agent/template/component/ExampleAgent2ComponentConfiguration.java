 ...
 * configuration properties for <code>ExampleAgent2</code>. The interface defines a
 ...
 * 
 * @see ExampleAgent2
 * @see ExampleAgent2Component
 * 
 * @author IBM
 * @version 0.9.0
 */
@OCD(name = "PowerMatcher Example Agent 2")
public interface ExampleAgent2ComponentConfiguration extends ExampleAgent2Configuration {
	...
	@Override
	@Meta.AD(required = false, deflt = EXAMPLE_DEFAULT, description = EXAMPLE_DESCRIPTION)
	...
	@Override
	@Meta.AD(required = false, description = EXAMPLE_ADAPTER_FACTORY_DESCRIPTION)
