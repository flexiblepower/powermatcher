...
import net.powermatcher.der.agent.miele.at.home.config.MieleDishWasherDeviceAgentConfiguration;
 ...
 * @version 0.9.0
 */
@OCD(name = "PowerMatcher Miele Dish Washer Device Agent")
public interface MieleDishWasherDeviceAgentComponentConfiguration extends
	MieleDishWasherDeviceAgentConfiguration {

	/**
	 * 
	 */
	public static final String EQUIPMENT_TYPE_DEFAULT = "Dishwasher";
