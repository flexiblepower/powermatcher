...
public interface ConnectorService {
	 ...
	 */
	public <T extends ConnectorService> String[] getAdapterFactory(Class<T> connectorType);
	 ...
	 */
	public ConnectorKeyService getConnectorKey(Class<? extends ConnectorService> connectorType);
