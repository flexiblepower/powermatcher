...
public class BidInfo {
	 ...
	 * @see #BidInfo(MarketBasis,PricePoint[])
	 */
	public BidInfo(final BidInfo other) {
	 ...
	 * @see #BidInfo(MarketBasis,PricePoint[])
	 */
	public BidInfo(final BidInfo other, final int newBidNumer) {
		this(other);
	 ...
	 * @see #BidInfo(MarketBasis,PricePoint[])
	 */
	public BidInfo(final MarketBasis marketBasis) {
	 ...
	 * @see #BidInfo(MarketBasis,PricePoint[])
	 */
	public BidInfo(final MarketBasis marketBasis, final double[] demand) {
	 ...
	 * @see #BidInfo(MarketBasis,PricePoint[])
	 */
	public BidInfo(final MarketBasis marketBasis, final PricePoint pricePoint) {
		this.marketBasis = marketBasis;
	 ...
	 * @see #BidInfo(MarketBasis,PricePoint[])
	 */
	public BidInfo(final MarketBasis marketBasis, final PricePoint pricePoint1, final PricePoint pricePoint2) {
	 ...
	 * @see #BidInfo(MarketBasis,PricePoint,PricePoint)
	 */
	private BidInfo(final MarketBasis marketBasis, final int bidNumber, final PricePoint[] pricePoints) {
		this.marketBasis = marketBasis;
	 ...
	 * @see #BidInfo(MarketBasis,PricePoint,PricePoint)
	 */
	public BidInfo(final MarketBasis marketBasis, final PricePoint[] pricePoints) {
	 ...
	 * @see #BidInfo(MarketBasis,PricePoint[])
	 */
	private BidInfo(MarketBasis marketBasis, final int bidNumber, double[] demand) {
		this.marketBasis = marketBasis;
		this.bidNumber = bidNumber;
		this.demand = demand;
	}
	 ...
	 */
	public BidInfo aggregate(final BidInfo other) {
		...
		return new BidInfo(this.marketBasis, this.bidNumber, aggregatedDemand); 
	}
	 ...
	 */
	public PriceInfo calculateIntersection(final double targetDemand) {
		...
		return new PriceInfo(this.marketBasis, intersectionPrice);
	}
	...
	public boolean equals(final Object obj) {
		BidInfo other = (BidInfo) ((obj instanceof BidInfo) ? obj : null);
		return this == other
	 ...
	 */
	public BidInfo subtract(final BidInfo other) {
		double[] otherDemand = other.toMarketBasis(this.marketBasis).getUnclonedDemand();
		double[] newDemand = this.getDemand();
		for (int i = 0; i < newDemand.length; i++) {
			newDemand[i] -= otherDemand[i];
		}
		return new BidInfo(this.marketBasis, this.bidNumber, newDemand); 
	}
	 ...
	 * @see #getMarketBasis()
	 */
	public BidInfo toMarketBasis(final MarketBasis newMarketBasis) {
		if (this.marketBasis.equals(newMarketBasis)) {
			...
			if (this.pricePoints == null) {
				...
				return new BidInfo(newMarketBasis, this.bidNumber, newDemand);
			} else {
				...
				return new BidInfo(newMarketBasis, this.bidNumber, newPricePoints);
			}
		}
	}
	 ...
	 */
	public BidInfo transpose(final double offset) {
		double[] newDemand = this.getDemand();
		for (int i = 0; i < newDemand.length; i++) {
			newDemand[i] += offset;
		}
