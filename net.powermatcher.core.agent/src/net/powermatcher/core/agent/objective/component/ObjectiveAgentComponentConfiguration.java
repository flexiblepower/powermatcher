 ...
 * @version 0.9.0
 */
@OCD(name = "PowerMatcher Objective Agent")
public interface ObjectiveAgentComponentConfiguration extends ObjectiveAgentConfiguration {
	...
	@Override
	@Meta.AD(required = false, description = OBJECTIVE_ADAPTER_FACTORY_DESCRIPTION)
	public String objective_adapter_factory();
	
	@Override
	@Meta.AD(required = false, deflt = BID_PROPERTY_DEFAULT_STR, description = BID_DESCRIPTION)
	...
	@Override
	@Meta.AD(required = false, description = MATCHER_LISTENER_ID_DESCRIPTION)
