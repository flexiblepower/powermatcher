...
public final class ColorFactory {
	...
	private static final Color[] PREDEFINED_COLORS = new Color[] { new Color(241, 154, 42), new Color(32, 171, 217),
			new Color(144, 97, 207), new Color(158, 156, 0) };
	...
	/**
	 * Returns number of colors predefined for VisualVM charts. Always contains
	 * at least 4 colors.
	 * 
	 ...
	 * 
	 * @param index
	 *            index of the predefined color pair
