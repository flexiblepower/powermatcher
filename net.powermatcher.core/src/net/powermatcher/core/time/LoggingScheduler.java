...
/**
 * {@link LoggingScheduler} is an implementation of
 * {@link ScheduledExecutorService}. It is used by all Powermatcher instances
 * that have to perform periodic tasks.
 * 
 * @author FAN
 * @version 2.0
 */
...
public class LoggingScheduler implements ScheduledExecutorService {
	...
	/**
	 * the {@link ScheduledExecutorService} that will be used to perform the
	 * periodic tasks.
	 */
	...
	/**
	 * Takes the tasks parameter and wraps all the {@link Callable}s in a
	 * {@link CallableWrapper}
	 * 
	 * @param tasks
