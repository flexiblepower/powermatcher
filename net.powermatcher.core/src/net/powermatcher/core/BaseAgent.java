...
/**
 * Base implementation of an {@link Agent}. It provides basic functionality
 * required in each {@link Agent}. Implements the {@link ObservableAgent}
 * interface to make sure the instance van send {@link AgentEvent}s to
 * {@link AgentObserver} s.
 * 
 * @author FAN
 * @version 2.0
 */
public abstract class BaseAgent implements ObservableAgent {
	...
	/**
	 * The service pid of a the managed Service of this instance in the OSGi
	 * container
	 */
	...
	protected boolean isInitialized() {
		return !(this.executorService == null || this.timeService == null);
	}
	...
	public boolean equals(Object obj) {
		...
		return canEqual(other) && other.getAgentId() == this.getClusterId()
				&& this.getAgentId() == other.getAgentId()
	...
	@Override
	public int hashCode() {
		return 211 * ((agentId == null ? 0 : agentId.hashCode())
				+ (clusterId == null ? 0 : clusterId.hashCode()) + (desiredParentId == null ? 0
