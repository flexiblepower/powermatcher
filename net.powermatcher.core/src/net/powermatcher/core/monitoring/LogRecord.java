...
/**
 * LogRecord is an abstract class that contains the basic information needed to
 * log an {@link AgentEvent}.
 * 
 * @author FAN
 * @version 2.0
 */
public abstract class LogRecord {
	...
	/**
	 * The {@link DateFormat} instance used to format the logTime and
	 * eventTimeStamp
	 */
	 ...
	 * 
	 * @param clusterId
	 *            The cluster id of the agent that published the
	 *            {@link AgentEvent}.
	 * @param agentId
	 *            The Agent Id that published the {@link AgentEvent}.
	 * @param qualifier
	 *            The qualifier of the agent that published the
	 *            {@link AgentEvent}.
	 */
	protected LogRecord(String clusterId, String agentId, Date logTime,
			Date eventTimestamp, DateFormat dateFormat) {
