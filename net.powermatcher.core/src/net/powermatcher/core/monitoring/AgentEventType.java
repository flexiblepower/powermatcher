...
/**
 * This <code>enum</code> contains all existing {@link AgentEvent}
 * implementations. This enum is used by {@link AgentEventLogger} to be able to
 * select an {@link AgentEventType} in the Apache Felix config admin.
 * 
 * @author FAN
 * @version 2.0
 */
public enum AgentEventType {
	...
	BID_EVENT("BidEvent", BidEvent.class), PRICE_EVENT("PriceEvent",
			PriceUpdateEvent.class), WHITELIST_EVENT("WhiteListEvent",
			WhitelistEvent.class), PEAK_SHAVING_EVENT("PeakShavingEvent",
			PeakShavingEvent.class);
	 ...
	 *            the runtime class of the {@link AgentEvent} implementations.
	 */
	private AgentEventType(String description,
			Class<? extends AgentEvent> classType) {
