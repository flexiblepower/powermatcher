...
public class Concentrator
        ...
        public void run() {
            try {
                ...
                synchronized (this) {
                    ...
                    coolDownEnds = context.currentTimeMillis() + config.minTimeBetweenBidsMS();
                }
     ...
     */
    private boolean bidUpdateScheduled = false;
        ...
        synchronized (bidUpdateCommand) {
            ...
            if (coolDownEnds > now) {
                ...
                if (!bidUpdateScheduled) {
                    context.schedule(bidUpdateCommand, Measure.valueOf(coolDownEnds - now, SI.MILLI(SI.SECOND)));
