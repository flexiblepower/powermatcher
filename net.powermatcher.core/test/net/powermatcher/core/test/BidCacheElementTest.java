...
public class BidCacheElementTest {
	...
	public void setUp() throws Exception {
		...
		pricePoints = new PricePoint[] {
				new PricePoint(new Price(marketBasis, 1), 30),
	...
	public void testBidCacheElement() {
		...
		BidCacheElement arrayBidCacheElement = new BidCacheElement(arrayBid,
				stamp1);
		...
		BidCacheElement pointBidCacheElement = new BidCacheElement(pointBid,
				stamp2);
		double[] expectedDemand = new double[] { 30.0, 27.5, 25.0, 22.5, 20.0 };
		assertThat(pointBidCacheElement.getBid().getDemand(),
	...
	public void testSetBid() {
		...
		double[] expectedDemand = new double[] { 30.0, 27.5, 25.0, 22.5, 20.0 };
		assertThat(arrayBidCacheElement.getBid().getDemand(),
				(is(equalTo(expectedDemand))));
		assertThat(arrayBidCacheElement.getTimestamp(), is(equalTo(stamp1)));
	}
